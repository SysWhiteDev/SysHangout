    ...
    <SessionProvider value={session}>
      <div className="flex min-h-screen w-full flex-col bg-card">
        ...
        <div className="mx-auto flex w-full max-w-7xl grow gap-5 p-5">
          <MenuBar className="sticky top-[98px] hidden h-fit flex-none space-y-3 rounded-2xl bg-neutral-200 px-2.5 py-2.5 shadow-sm dark:bg-neutral-900 sm:block lg:px-2.5 xl:w-60" />{" "}
          {children}
          <TrendingSidebar />
        </div>
